...
SYSTEM_PROMPT = """Bạn là trợ lý AI hữu ích. Chỉ dùng context dưới đây để trả lời.
Nếu context không chứa thông tin, hãy nói rõ là bạn không tìm thấy.
...
# ── 5. Main ────────────────────────────────────────────────────────────────
def main():
    """Chạy toàn bộ Bước 1: dựng vectorstore, build chain, hỏi 50 câu và gửi trace lên LangSmith."""
    print("=" * 60)
